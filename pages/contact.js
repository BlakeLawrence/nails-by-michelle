  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row">
        <div className="p-4 flex flex-col items-center w-full md:w-2/3 lg:w-2/3 2xl:w-1/3  mt-12 ml-2 mr-2 sm:ml-8 bg-pink-100 rounded-md shadow-lg">
        ...
        {/* Contact details Div */}
        <div className="w-full sm:w-1/2 mt-12 p-4 rounded-md bg-gray-200 shadow-lg">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Reprehenderit quas ipsa ducimus aspernatur, incidunt voluptas dolor,
            assumenda libero obcaecati nulla mollitia sequi nemo recusandae non
            blanditiis itaque cumque repudiandae similique.
          </p>
        </div>
      </div>
    </>
