          ...
          <ul className="w-2/3 pt-12 pb-2">
            ...
            <div className="pt-6 md:pt-12">
              <Link href="/price-list">
                <button className="text-[11px] sm:text-[16px] py-3 bg-purple-400 border-[1px] font-semibold font-[montserrat] w-20 md:w-28 border-purple-400 rounded-full text-[#ffffff] hover:scale-110 ease-in duration-100 mb-8 sm:mb-12">
                  Price List
                </button>
              </Link>
            </div>
